...
(function() {
  var Bundle, Message, MockOscPacketGenerator, MockOscPacketParser, TEST_MESSAGES, arrayBuffer, bufferEqual, createInt8Array, desc, expect, i, int8array, isBuffer, length, messageEqual, name, nodeBuffer, osc, _fn, _fn1, _i, _ref, _ref1,
  ...
  describe("AbstractOscPacketGenerator", function() {
    ...
    return describe("generate a bundle", function() {
      it("should write '#bundle', timetag and messages", function() {
        ...
        bundle = new osc.Bundle(new Date).message("/foo", osc.Impulse).message("/bar", osc.Impulse);
